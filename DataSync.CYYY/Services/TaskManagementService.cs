...
public class TaskManagementService
{
    ...
    private static SyncTask CreateTaskCopy(SyncTask source, string copyName, string copyCode)
    {
        return new SyncTask
        {
            ...
            AdditionalTriggerServerCodes = source.AdditionalTriggerServerCodes,
            ...
            PatientContinuousSyncEnabled = source.PatientContinuousSyncEnabled,
            PatientContinuousSyncIntervalSeconds = source.PatientContinuousSyncIntervalSeconds,
            PatientContinuousSyncLookbackMinutes = source.PatientContinuousSyncLookbackMinutes,
            AdmissionSourceServerCode = source.AdmissionSourceServerCode,
            AdmissionTimeField = source.AdmissionTimeField,
            DischargeSourceServerCode = source.DischargeSourceServerCode,
            DischargeTimeField = source.DischargeTimeField,
    ...
    private static SyncTaskInterface CloneInterface(SyncTaskInterface source)
    {
        return new SyncTaskInterface
        {
            ...
            ApiInterfaceId = source.ApiInterfaceId,
            ...
            SqlServerDatabase = source.SqlServerDatabase,
            SqlServerUsername = source.SqlServerUsername,
            SqlServerPassword = source.SqlServerPassword,
            SqlServerTrustCertificate = source.SqlServerTrustCertificate,
            QuerySql = source.QuerySql,
            QueryPath = source.QueryPath,
            UseTodayTimeRange = source.UseTodayTimeRange,
            ContinuousPollingEnabled = source.ContinuousPollingEnabled,
            ContinuousPollingIntervalSeconds = source.ContinuousPollingIntervalSeconds,
            PatientContinuousSyncEnabled = source.PatientContinuousSyncEnabled,
            ContinuousUseTimeRange = source.ContinuousUseTimeRange,
            ContinuousRecordKeyFields = source.ContinuousRecordKeyFields,
            ContinuousUseRowHash = source.ContinuousUseRowHash,
            QueryStartTimeSourceServerCode = source.QueryStartTimeSourceServerCode,
            QueryStartTimeSourceField = source.QueryStartTimeSourceField,
            QueryEndTimeSourceServerCode = source.QueryEndTimeSourceServerCode,
            QueryEndTimeSourceField = source.QueryEndTimeSourceField,
            AccessWindowEnabled = source.AccessWindowEnabled,
            AccessWindowStart = source.AccessWindowStart,
            AccessWindowEnd = source.AccessWindowEnd,
            ...
            QueryMappings = source.QueryMappings,
